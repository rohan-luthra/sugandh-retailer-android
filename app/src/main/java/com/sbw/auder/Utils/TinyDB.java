...
public class TinyDB {
    ...
    public boolean putImageWithFullPath(String fullPath, Image theBitmap) {
        return !(fullPath == null || theBitmap == null) && saveBitmap(fullPath, theBitmap);
    }
    ...
    private boolean saveBitmap(String fullPath, Image bitmap) {
        if (fullPath == null || bitmap == null)
            return false;
    ...
    public ArrayList<DistModel> getDistModelListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<DistModel> objects =  new ArrayList<DistModel>();

        for(String jObjString : objStrings){
            DistModel value  = (DistModel) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<OrderTypeModel> getOrderTypeModelListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<OrderTypeModel> objects =  new ArrayList<OrderTypeModel>();

        for(String jObjString : objStrings){
            OrderTypeModel value  = (OrderTypeModel) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListDistModel(String key, ArrayList<DistModel> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public void putListOrderTypeModel(String key, ArrayList<OrderTypeModel> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
    ...
    public void putOrderData(String key, ArrayList<OrderModel> object){
        Gson gson = new Gson();
        String json = gson.toJson(object);
        preferences.edit().putString(key,json).apply();
    }

    public  ArrayList<OrderModel> getOrderData(String key){
        Gson gson = new Gson();
    ...
    public void setImagePath(String key,String path){
        preferences.edit().putString("Image"+key,path).apply();
    }
    public String getImagePath(String key){
        return preferences.getString("Image"+key,null);
    }

    public static  void setAudioPath(String key , String audioPath){
        preferences.edit().putString("Audio"+key,audioPath).apply();
    }
    public String getAudioPath(String key){
        return  preferences.getString("Audio"+key,null);
    }
...
//                + "/"+ context.getResources().getString(R.string.app_name) +"");
        ...
        File dcimDir = new File(context.getExternalFilesDir(null),DIRECTORY_PICTURES);
        ...
        if (!picsDir.exists()) {
            success = picsDir.mkdirs();//make if not exist
        }
        if (success) {
            File imageFile = new File(picsDir, imageFileName);
...
//            Toast.makeText(context, "IMAGE SAVED", Toast.LENGTH_LONG).show();
    ...
    public static  void setVideoPath(String key , String videoPath){
        preferences.edit().putString("Video_"+key,videoPath).apply();
    }
    public String getVideoPath(String key){
        return  preferences.getString("Video_"+key,null);
    }

    public String saveImageWithoutExt(Bitmap image,String fileName) {
        String savedImagePath = null;
...
//            Toast.makeText(context, "IMAGE SAVED", Toast.LENGTH_LONG).show();
    ...
    public ArrayList<String> getSliderImages(String key) {
        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<String>>(){}.getType();
        return gson.fromJson(preferences.getString(key,null),type);
    }
    public void putSliderImages(String key, ArrayList<String> object){
        Gson gson = new Gson();
        String json = gson.toJson(object);
        preferences.edit().putString(key,json).apply();
    }
